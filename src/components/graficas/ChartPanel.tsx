  ...
  return (
    <div className="bg-[var(--surface-color)] radius-panel border border-[var(--border-color)]">
      <div className="px-3 py-2 border-b border-[var(--border-color)] flex items-center justify-between">
        ...
        <div className="bg-[var(--input-bg)] radius-badge p-0.5 flex gap-0.5">
          <button
      ...
      <div className="p-3">
        {variables.length > 0 && (
          <select
            ...
            className="mb-3 px-2 py-1 bg-[var(--input-bg)] radius-badge text-[10px] font-mono text-[var(--text-color)] border border-[var(--border-color)] focus:outline-none focus:ring-1 focus:ring-[var(--accent)] appearance-none"
          >
            {variables.map((v) => (
