...
export function Header({ onToggleSidebar }: HeaderProps) {
  ...
  return (
    <header className="bg-[var(--surface-color)] border-b border-[var(--border-color)] px-4 py-2.5 flex items-center justify-between shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-[10px] font-mono text-[var(--text-muted)]">Tibo Conduit</span>
        <button
          onClick={toggleTema}
